...
'''Estudiamos los asteorides en la zona proxima a la resonancia  e incluimos la interaccion con Saturno'''
...
z_jup,x_sat,y_sat,z_sat)    # Cambiar en la funcion grav_sun_Jupiter_Marte y poner la masa de Saturno
