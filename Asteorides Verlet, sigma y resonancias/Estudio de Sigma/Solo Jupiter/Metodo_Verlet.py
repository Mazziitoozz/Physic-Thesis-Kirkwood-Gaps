...
# _next significa del paso siguiente y si no lleva nada significa que es el actual     
        ...
        [ax, ay, az] = a(x, y, z,x_jup[i], y_jup[i] ,z_jup[i],x_mar[i], y_mar[i] ,z_mar[i])     #Decimos que esos valores son los de la funcion aceleracion previamente creada
    
        x_next= x + vx * dt + 0.5 * ax * dt ** 2    
        y_next= y + vy * dt + 0.5 * ay * dt ** 2    
        z_next= z + vz * dt + 0.5 * az * dt ** 2
        
        [ax_next, ay_next, az_next] = a(x_next, y_next, z_next, x_jup[i], y_jup[i] ,z_jup[i],x_mar[i], y_mar[i] ,z_mar[i]) # Definimos las aceleraciones del paso siguiente
