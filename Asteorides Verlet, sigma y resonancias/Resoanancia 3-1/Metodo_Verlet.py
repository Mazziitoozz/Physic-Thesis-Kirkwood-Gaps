...
# _next significa del paso siguiente y si no lleva nada significa que es el actual     
        ...
        [ax_next, ay_next, az_next] = a(x_next, y_next, z_next) # Definimos las aceleraciones del paso siguiente
...
def Verlet2(a,r0,v0,dt,tend,x_jup_V, y_jup_V ,z_jup_V):
#Creamos vectores de las posiciones, tiempo y velocidades
...
# _next significa del paso siguiente y si no lleva nada significa que es el actual     
        ...
        [ax, ay, az] = a(x, y, z,x_jup_V[i], y_jup_V[i] ,z_jup_V[i])     #Decimos que esos valores son los de la funcion aceleracion previamente creada
    
        x_next= x + vx * dt + 0.5 * ax * dt ** 2    
        y_next= y + vy * dt + 0.5 * ay * dt ** 2    
        z_next= z + vz * dt + 0.5 * az * dt ** 2
        
        [ax_next, ay_next, az_next] = a(x_next, y_next, z_next, x_jup_V[i], y_jup_V[i] ,z_jup_V[i]) # Definimos las aceleraciones del paso siguiente
